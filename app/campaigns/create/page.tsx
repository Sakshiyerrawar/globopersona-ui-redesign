...
export default function CreateCampaignPage() {
  ...
  const isStep1Disabled =
    !campaignName || (lists.length > 0 && !selectedList) || noLists;
  ...
  return (
    <MainLayout>
      <div className="flex-1 bg-[#f8fafc] p-8 min-h-screen">
        ...
        <button
          onClick={handleBack}
          className="text-[#64748b] text-[14px] hover:text-[#0f172a] mb-6 inline-block"
        >
          &lt; Back to {step === 1 ? "Campaigns" : "Previous Step"}
        </button>

        {/* TOP TITLE & SUBTITLE */}
        <p className="text-[#64748b] text-[14px] mb-2 font-medium">
          Step {step} of 3
        </p>
        ...
        <p className="text-[#64748b] text-[15px] mb-8 max-w-4xl">
          {step === 1
            ? "Set up your campaign name and choose which audience to target"
            : step === 2
              ? "Write your subject line and compose your email content"
            ...
            {step === 1 && (
              <>
                ...
                <p className="text-[#64748b] text-[14px] ml-9 mb-8">
                  Enter your campaign information and select your target
                  audience
                </p>
                    ...
                    {noLists && (
                      <div className="mt-4 bg-[#fffbeb] border border-[#fde68a] rounded-xl p-5 shadow-sm">
                        <div className="flex items-center gap-2 mb-2">
                          ...
                          <h3 className="font-semibold text-[#b45309]">
                            No Email Lists Available
                          </h3>
                        </div>
                        <p className="text-[#d97706] text-[14px] mb-4">
                          You need to create an email list with contacts before
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      >
                        ...
                        <option value="ai-optimized">
                          AI Optimized (Smart Sending)
                        </option>
                      </select>
                      <ChevronDown
                        className="absolute right-4 top-1/2 -translate-y-1/2 text-[#94a3b8] pointer-events-none"
            ...
            {step === 3 && (
              <>
                  ...
                  <div className="bg-[#f8fafc] border border-[#e2e8f0] rounded-xl p-6">
                    <div className="grid grid-cols-2 gap-y-6">
                      ...
                      <div>
                        ...
                        <p className="text-[15px] font-medium text-[#0f172a] capitalize">
                          {selectedTemplate.replace("-", " ")}
                        </p>
                      </div>
                      <div className="col-span-2 pt-4 border-t border-[#e2e8f0]">
                        <p className="text-[12px] font-bold text-[#94a3b8] tracking-wider mb-2">
                          SUBJECT LINE
                        </p>
                        <p className="text-[15px] font-medium text-[#0f172a] bg-white p-3 rounded-lg border border-[#e2e8f0]">
                          {subjectLine}
                        </p>
                      </div>
                    </div>
                ...
                <div className="mt-10 flex justify-end">
                  ...
                  >
                    {isLaunching ? "Saving..." : "Save & Launch"}{" "}
          ...
          <div className="lg:col-span-1 space-y-6 mt-2">
            ...
            <div className="space-y-5">
              ...
              <div>
                ...
                <p className="text-[15px] font-medium text-[#0f172a]">
                  {selectedListObj
                    ? `${selectedListObj.name} (${selectedListObj.contacts.length})`
                    : "No list selected"}
                </p>
              </div>
            </div>
            ...
            <div className="mt-6">
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-3">
                  ...
                  <span
                    className={`text-[14px] ${step >= 2 ? "text-[#0f172a] font-medium" : "text-[#64748b]"}`}
                  >
                ...
                <div className="flex items-center gap-3">
                  ...
                  <span
                    className={`text-[14px] ${step >= 3 ? "text-[#0f172a] font-medium" : "text-[#64748b]"}`}
                  >
                    Review & Launch
                  </span>
                </div>
